...
export default defineConfig({
	...
	plugins: [
		react(),
		// Match the parent Ouroboros app's font loading exactly. Without this,
		// the plugin falls back to system sans-serif and browser-synthesized
		// bold, which renders lighter/thinner than the parent's real Poppins.
		webfontDownload([
